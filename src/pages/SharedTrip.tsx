  ...
  if (!trip) {
    return (
      <div className="text-center py-12 font-interface">
        <h2 className="text-2xl font-bold text-zinc-800">Shared Trip not found</h2>
        <Link to="/" className="text-indigo-650 hover:underline mt-2 inline-block">Go to Dashboard</Link>
      </div>
    );
  }
