  ...
  return (
    <footer className="bg-[#090B0D] border-t border-[#292F36] text-[#B8BEC6] font-interface selection:bg-[#D9A752]/30 selection:text-[#D9A752]">
      <div className="max-w-7xl mx-auto px-6 py-16 sm:py-20 space-y-12">
        ...
        {/* SECTION 1: PRODUCT */}
        <div className="pt-8 border-t border-[#292F36] space-y-4">
          <span className="text-xs font-bold uppercase tracking-widest text-[#D9A752] block">
            Product
          </span>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-y-3 gap-x-6 text-sm">
        ...
        <div className="pt-8 border-t border-[#292F36] space-y-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 gap-y-3 gap-x-6 text-sm">
        ...
        <div className="pt-8 border-t border-[#292F36] space-y-4">
          ...
          <div className="flex flex-wrap gap-x-8 gap-y-3 text-sm">
            <Link to="/login" className="text-[#B8BEC6] hover:text-white font-medium transition-colors">
              Log in
            </Link>
